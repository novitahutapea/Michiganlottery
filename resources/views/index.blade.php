...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/michigan.png" type="image/x-icon">
                        ...
                        <div class="header-top-area-inner">
                            ...
                            <div class="right-area">
                                <div class="log-reg-area">
                                    ...
                                    <a href="{{route('result')}}" class="custom-button2">Todos los resultados</a>
                                </div>
                                {{-- <div class="cart-area">
                                    <div class="icon">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="text">Enciéndase para tener la oportunidad de ganar en este electrizante juego instantáneo!</p>
                    {{-- <a href="#" class="custom-button2">Hasi Jokatzen Orain</a> --}}
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-feature">
                        ...
                        <h4 class="title">Seguro y seguridad</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-feature">
                        ...
                        <h4 class="title">Cero comisión</h4>
                    </div>
                </div>
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="single-feature">
                ...
                <div class="col-lg-9" style="margin-top: 200px">
                    <div class="content">
                        <div class="section-header">
                            ...
                            <p class="text">
                            Compruebe su lotería en línea, encontrar todos los números ganadores de lotería y ver si usted ganó los últimos premios mayores de lotería
                            </p>
                            <br><br><br><br>
                        </div>
                    </div>
