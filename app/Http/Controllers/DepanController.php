...
class DepanController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($numberImg->count() <= 0 && $numberImgBackup->count() <= 0) {
            ...
            if ($numberImg[0]->waktu == "05:30:00") {
                $waktu = "Morning";
            } else if ($numberImg[0]->waktu == "11:30:00") {
                $waktu = "Day";
            } else if ($numberImg[0]->waktu == "23:59:00") {
                $waktu = "Night";
            }
        } else {
            ...
            if ($numberImgBackup[0]->waktu == "05:30:00") {
                $waktu = "Morning";
            } else if ($numberImgBackup[0]->waktu == "11:30:00") {
                $waktu = "Day";
            } else if ($numberImgBackup[0]->waktu == "23:59:00") {
                $waktu = "Night";
            }
        }
